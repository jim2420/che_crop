...
plt.title("Maize Irrigated + Rainfed",fontsize=20)
#plt.xlabel("Year",fontsize=18)
plt.ylabel("Area changes (%)",fontsize=20)
plt.tick_params(axis='both',labelsize=20)
plt.setp(plt.gca(), xticklabels=[])

leg = plt.legend(loc=2,fancybox=True, fontsize=20)
...
ax.set_ylim([-55,55])
ax.xaxis.set_major_formatter(DateFormatter('%Y'))
plt.title("Maize Irrigated",fontsize=20)
#plt.xlabel("Year",fontsize=18)
plt.ylabel("Area changes (%)",fontsize=20)
plt.tick_params(axis='both',labelsize=20)
plt.setp(plt.gca(), xticklabels=[])
...
ax.set_ylim([-55,55])
ax.xaxis.set_major_formatter(DateFormatter('%Y'))
plt.title("Maize Rainfed",fontsize=20)
plt.xlabel("Year",fontsize=20)
plt.ylabel("Area changes (%)",fontsize=20)
plt.tick_params(axis='both',labelsize=20)


plt.savefig('maize_area_g.png',dpi=300,bbox_inches='tight')
plt.show()
