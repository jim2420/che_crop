...
edat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/soytemp_historical_constco2_constcli_rf_nofert_0.5x0.5.nc','r')
eiyield1ynew = edat.variables['totalyield'][95:105,:,:]

edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/soytemp_historical_constco2_constcli_irrig_nofert_0.5x0.5.nc','r')
eiyield2ynew = edat2.variables['totalyield'][95:105,:,:]

edat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/soytemp_historical_constco2_constcli_rf_fert_0.5x0.5.nc','r')
eiyield3ynew = edat3.variables['totalyield'][95:105,:,:]

edat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/soytemp_historical_co2_constcli_rf_nofert_0.5x0.5.nc','r')
eiyield4ynew = edat4.variables['totalyield'][95:105,:,:]

edat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/soytemp_historical_constco2_cli_rf_nofert_0.5x0.5.nc','r')
...
for i in range (1,9):
	...
	if i==9:
		i=5
        a1=((iyield2ynew*mmarea*10000/gridarea2)-(iyield1ynew*mmarea*10000/gridarea2))*100*-1/(iyield1ynew*mmarea*10000/gridarea2)	
        a2=((iyield3ynew*mmarea*10000/gridarea2)-(iyield1ynew*mmarea*10000/gridarea2))*100*-1/(iyield1ynew*mmarea*10000/gridarea2)
        a3=((iyield4ynew*mmarea*10000/gridarea2)-(iyield1ynew*mmarea*10000/gridarea2))*100*-1/(iyield1ynew*mmarea*10000/gridarea2)
        a4=((iyield5ynew*mmarea*10000/gridarea2)-(iyield1ynew*mmarea*10000/gridarea2))*100*-1/(iyield1ynew*mmarea*10000/gridarea2)

	allyinew=N.average(a1,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
	allynnew=N.average(a2,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
	allycnew=N.average(a3,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
	allyclinew=N.average(a4,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
	...
	scli[i]=N.std(ee)
        ...
        ea1=((eiyield2ynew*mmarea*10000/gridarea2)-(eiyield1ynew*mmarea*10000/gridarea2))*100*1/(iyield1ynew*mmarea*10000/gridarea2)
        ea2=((eiyield3ynew*mmarea*10000/gridarea2)-(eiyield1ynew*mmarea*10000/gridarea2))*100*1/(iyield1ynew*mmarea*10000/gridarea2)
        ea3=((eiyield4ynew*mmarea*10000/gridarea2)-(eiyield1ynew*mmarea*10000/gridarea2))*100*1/(iyield1ynew*mmarea*10000/gridarea2)
        ea4=((eiyield5ynew*mmarea*10000/gridarea2)-(eiyield1ynew*mmarea*10000/gridarea2))*100*1/(iyield1ynew*mmarea*10000/gridarea2)
        
        eallyinew=N.average(ea1,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        eallynnew=N.average(ea2,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        eallycnew=N.average(ea3,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
        eallyclinew=N.average(ea4,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
...
a3=((iyield4ynew*mmarea*10000/gridarea2)-(iyield1ynew*mmarea*10000/gridarea2))*100*-1/(iyield1ynew*mmarea*10000/gridarea2)
a4=((iyield5ynew*mmarea*10000/gridarea2)-(iyield1ynew*mmarea*10000/gridarea2))*100*-1/(iyield1ynew*mmarea*10000/gridarea2)
allyinew=N.average(a1,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
allynnew=N.average(a2,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
allycnew=N.average(a3,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
allyclinew=N.average(a4,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
...
eallyinew=N.average(ea1,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
eallynnew=N.average(ea2,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
eallycnew=N.average(ea3,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
eallyclinew=N.average(ea4,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
...
plt.savefig('soy_region_allre.png')
plt.show()
