...
dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/heat/fixedirr_fertfao_new/maihis_irr_fertfao/output/maihis_irr_fertfao_tt.nc','r')
iyield1ynew = dat.variables['g_Temp'][0:105,7,0,:,:]
