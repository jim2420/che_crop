...
ax.plot_date(xdates,finalcnew,"k-",label="'CO$_{2}$'",linewidth='3')
ax.plot_date(xdates,finalclinew,"r-",label="Climate",linewidth='3')
...
plt.savefig('soybean_his_irrfixed_all_paper.png')
plt.show()
