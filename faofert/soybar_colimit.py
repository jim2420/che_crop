...
dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1_n/soytemp_historical_co2_irrig_fert_0.5x0.5.nc','r')
iyield1ynewn = dat.variables['total_gfna'][0:105,:,:]
iyield1ynewi = dat.variables['total_gWS'][0:105,:,:]

dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1_n/soytemp_historical_co2_rf_fert_0.5x0.5.nc','r')
iyield2ynewn = dat2.variables['total_gfna'][0:105,:,:]
iyield2ynewi = dat2.variables['total_gWS'][0:105,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1_n/soytemp_historical_co2_irrig_nofert_0.5x0.5.nc','r')
iyield3ynewn = dat3.variables['total_gfna'][0:105,:,:]
iyield3ynewi = dat3.variables['total_gWS'][0:105,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1_n/soytemp_historical_constco2_irrig_fert_0.5x0.5.nc','r')
iyield4ynewn = dat4.variables['total_gfna'][0:105,:,:]
iyield4ynewi = dat4.variables['total_gWS'][0:105,:,:]


dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1_n/soytemp_historical_constclim_irrig_fert_0.5x0.5.nc','r')
iyield5ynewn = dat5.variables['total_gfna'][0:105,:,:]
iyield5ynewi = dat5.variables['total_gWS'][0:105,:,:]


dat6=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1_n/soytemp_historical_co2_rf_nofert_0.5x0.5.nc','r')
...
iyield1ynewi= ma.masked_where(iyield1ynewi>1.0,iyield1ynewi)
iyield2ynewi= ma.masked_where(iyield2ynewi>1.0,iyield2ynewi)
iyield3ynewi= ma.masked_where(iyield3ynewi>1.0,iyield3ynewi)
iyield4ynewi= ma.masked_where(iyield4ynewi>1.0,iyield4ynewi)
iyield5ynewi= ma.masked_where(iyield5ynewi>1.0,iyield5ynewi)
iyield6ynewi= ma.masked_where(iyield6ynewi>1.0,iyield6ynewi)

iyield1ynewn= ma.masked_where(iyield1ynewn>1.0,iyield1ynewn)
iyield2ynewn= ma.masked_where(iyield2ynewn>1.0,iyield2ynewn)
iyield3ynewn= ma.masked_where(iyield3ynewn>1.0,iyield3ynewn)
iyield4ynewn= ma.masked_where(iyield4ynewn>1.0,iyield4ynewn)
iyield5ynewn= ma.masked_where(iyield5ynewn>1.0,iyield5ynewn)
iyield6ynewn= ma.masked_where(iyield6ynewn>1.0,iyield6ynewn)
...
rr=r_value**2
ax.annotate('P = 0.04', xy=(0.04, 0.10),xycoords='axes fraction',fontsize=18,color='blue')
...
rr=r_value**2
ax.annotate('P = 0.08', xy=(0.04, 0.10),xycoords='axes fraction',fontsize=18,color='blue')
ax.annotate('R$^2$ = {:04.2f}'.format(rr), xy=(0.01, 0.03),xycoords='axes fraction',fontsize=18,color='blue')
...
plt.savefig('soy_his_inco_paper11.png')
plt.show()
