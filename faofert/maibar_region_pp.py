...
dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/heat/fixedirr_fertfao_new/maihis_irr_fertfao/output/maihis_irr_fertfao_pp.nc','r')
iyield1ynew = dat.variables['g_Precip'][0:105,7,0,:,:]
...
#	ax.set_yticks([-15,0,15,30,45,60 ])
	...
	opacity = 0.6
        ...
        xx=range(1902,2006)
	ax.plot(xx,ii[1:105,idx],"k-",label="Precipitation (mm)")
	plt.tight_layout()
