...
maizeto1i,lonisam2=shiftgrid(0.5,maizetropo,lonisam1,start=True)
maizeto1r,lonisam2=shiftgrid(0.5,maizetempo,lonisam1,start=True)
...
plt.savefig('soy_his_irrfixed_paper2.png')
plt.show()
