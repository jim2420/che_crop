...
for i in range (1,9):
	...
	scli[i]=N.std(ee)
        ...
        ebb=(eallyinew-eallynew)/eallynew*100
        ecc=(eallynnew-eallynew)/eallynew*100
        edd=(eallycnew-eallynew)/eallynew*100
        eee=(eallyclinew-eallynew)/eallynew*100
...
plt.savefig('soy_region_all3.png')
plt.show()
