...
dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/heat/fixedirr_fertfao_new/soyhis_irr_fertfao/output/soyhis_irr_fertfao_pp.nc','r')
iyield1ynew = dat.variables['g_Precip'][0:105,7,1,:,:]
