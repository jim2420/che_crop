...
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp45/heat/new1/maizetemp_rcp45_co2_rf_fert_0.5x0.5.nc','r')
iyield2ynew = dat2.variables['totalyield'][:,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp45/heat/new1/maizetemp_rcp45_co2_irrig_fert_0.5x0.5.nc','r')
iyield3ynew = dat3.variables['totalyield'][:,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp45/heat/new1/maizetemp_rcp45_co2_irrig_fert_0.5x0.5.nc','r')
iyield4ynew = dat4.variables['totalyield'][:,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp45/heat/new1/maizetemp_rcp45_co2_irrig_fert_0.5x0.5.nc','r')
iyield5ynew = dat5.variables['totalyield'][:,:,:]


dat6=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp45/heat/new1/maizetemp_rcp45_co2_rf_nofert_0.5x0.5.nc','r')
...
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp45/heat/new1/maizetemp_rcp45_co2_rf_fert_0.5x0.5_n.nc','r')
iyield2ynewn = dat2.variables['total_gfna'][:,:,:]
iyield2ynewi = dat2.variables['total_gWS'][:,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp45/heat/new1/maizetemp_rcp45_co2_irrig_fert_0.5x0.5_n.nc','r')
iyield3ynewn = dat3.variables['total_gfna'][:,:,:]
iyield3ynewi = dat3.variables['total_gWS'][:,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp45/heat/new1/maizetemp_rcp45_co2_irrig_fert_0.5x0.5_n.nc','r')
iyield4ynewn = dat4.variables['total_gfna'][:,:,:]
iyield4ynewi = dat4.variables['total_gWS'][:,:,:]


dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp45/heat/new1/maizetemp_rcp45_co2_irrig_fert_0.5x0.5_n.nc','r')
iyield5ynewn = dat5.variables['total_gfna'][:,:,:]
iyield5ynewi = dat5.variables['total_gWS'][:,:,:]


dat6=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp45/heat/new1/maizetemp_rcp45_co2_rf_nofert_0.5x0.5_n.nc','r')
...
#allyinnewn=N.average(iyield6ynewn,axis=(1,2))
print allyinnewn

#twn=allyinnewi+allyinnewn
#mwn=N.maximum(allyinnewi,allyinnewn)
##print allyinnewi
##print allyinnewn
##print mwn
#cwn=1-abs(allyinnewi-allyinnewn)
#ctwn=cwn/twn
#cmwn=cwn/mwn
...
aa1=aa[1:95]
ax.scatter(twn1,aa1,c='black',alpha=1)
...
ax.scatter(mwn1,aa1,c='black',alpha=1)
...
plt.savefig('maize_45_inco_paper.png')
plt.show()
