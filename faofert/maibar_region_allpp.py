...
edat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/maizetemp_historical_constco2_constcli_rf_nofert_0.5x0.5_pp.nc','r')
eiyield1ynew = edat.variables['g_Precip'][95:105,7,0,:,:]

edat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/maizetemp_historical_constco2_constcli_irrig_nofert_0.5x0.5_pp.nc','r')
eiyield2ynew = edat2.variables['g_Precip'][95:105,7,0,:,:]

edat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/maizetemp_historical_constco2_constcli_rf_fert_0.5x0.5_pp.nc','r')
eiyield3ynew = edat3.variables['g_Precip'][95:105,7,0,:,:]

edat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/maizetemp_historical_co2_constcli_rf_nofert_0.5x0.5_pp.nc','r')
eiyield4ynew = edat4.variables['g_Precip'][95:105,7,0,:,:]

edat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/equili/maizetemp_historical_constco2_cli_rf_nofert_0.5x0.5_pp.nc','r')
eiyield5ynew = edat5.variables['g_Precip'][95:105,7,0,:,:]
 



dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_irrig_fert_0.5x0.5_pp.nc','r')
iyield1ynew = dat.variables['g_Precip'][95:105,7,0,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_rf_fert_0.5x0.5_pp.nc','r')
iyield2ynew = dat2.variables['g_Precip'][95:105,7,0,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_irrig_nofert_0.5x0.5_pp.nc','r')
iyield3ynew = dat3.variables['g_Precip'][95:105,7,0,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_constco2_irrig_fert_0.5x0.5_pp.nc','r')
iyield4ynew = dat4.variables['g_Precip'][95:105,7,0,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_constclim_irrig_fert_0.5x0.5_pp.nc','r')
iyield5ynew = dat5.variables['g_Precip'][95:105,7,0,:,:]


dat6=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_constclim_irrig_fert_0.5x0.5_pp.nc','r')
iyield6ynew = dat6.variables['g_Precip'][95:105,7,0,:,:]
...
iyield1ynew= ma.masked_where(iyield1ynew<=0.,iyield1ynew)
eiyield1ynew[N.isnan(eiyield1ynew)] = 0
eiyield1ynew[N.isinf(eiyield1ynew)] = 0
eiyield1ynew= ma.masked_where(eiyield1ynew<=0.,eiyield1ynew)


iyield2ynew[N.isnan(iyield2ynew)] = 0
iyield2ynew[N.isinf(iyield2ynew)] = 0
iyield2ynew= ma.masked_where(iyield2ynew<=0.,iyield2ynew)
eiyield2ynew[N.isnan(eiyield2ynew)] = 0
eiyield2ynew[N.isinf(eiyield2ynew)] = 0
eiyield2ynew= ma.masked_where(eiyield2ynew<=0.,eiyield2ynew)

iyield3ynew[N.isnan(iyield3ynew)] = 0
iyield3ynew[N.isinf(iyield3ynew)] = 0
iyield3ynew= ma.masked_where(iyield3ynew<=0.,iyield3ynew)
eiyield3ynew[N.isnan(eiyield3ynew)] = 0
eiyield3ynew[N.isinf(eiyield3ynew)] = 0
eiyield3ynew= ma.masked_where(eiyield3ynew<=0.,eiyield3ynew)

iyield4ynew[N.isnan(iyield4ynew)] = 0
iyield4ynew[N.isinf(iyield4ynew)] = 0
iyield4ynew= ma.masked_where(iyield4ynew<=0.,iyield4ynew)
eiyield4ynew[N.isnan(eiyield4ynew)] = 0
eiyield4ynew[N.isinf(eiyield4ynew)] = 0
eiyield4ynew= ma.masked_where(eiyield4ynew<=0.,eiyield4ynew)

iyield5ynew[N.isnan(iyield5ynew)] = 0
iyield5ynew[N.isinf(iyield5ynew)] = 0
iyield5ynew= ma.masked_where(iyield5ynew<=0.,iyield5ynew)
eiyield5ynew[N.isnan(eiyield5ynew)] = 0
eiyield5ynew[N.isinf(eiyield5ynew)] = 0
eiyield5ynew= ma.masked_where(eiyield5ynew<=0.,eiyield5ynew)
...
#        eallynew=N.average(eiyield1ynew,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
#        eallyinew=N.average(eiyield2ynew,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
#        eallynnew=N.average(eiyield3ynew,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
#        eallycnew=N.average(eiyield4ynew,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
#        eallyclinew=N.average(eiyield5ynew,weights=maizeto3*landfrac2*gridarea2,axis=(1,2))
...
#eallynew=N.average(eiyield1ynew,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
#eallyinew=N.average(eiyield2ynew,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
#eallynnew=N.average(eiyield3ynew,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
#eallycnew=N.average(eiyield4ynew,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
#eallyclinew=N.average(eiyield5ynew,weights=maizeto2*landfrac2*gridarea2,axis=(1,2))
...
plt.savefig('mai_region_allpp.png')
plt.show()
