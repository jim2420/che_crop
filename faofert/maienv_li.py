...
aa=(iyield1-iyield6)/iyield6*100
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield2,cmap=plt.cm.jet,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=16)
...
map.drawcountries()
map.drawmapboundary()
bb=(iyield2-iyield6)/iyield6*100
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield3,cmap=plt.cm.jet,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=16)
...
map.drawcountries()
map.drawmapboundary()
cc=(iyield3-iyield6)/iyield6*100
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield4,cmap=plt.cm.jet,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=16)
...
cs1 = map.pcolormesh(x,y,aa-bb-cc,cmap=plt.cm.bwr,norm=norm)
...
plt.savefig('maizefixedi_1996_2005_li_paper.jpg',dpi=300,bbox_inches='tight')
plt.show()
