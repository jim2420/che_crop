...
allynew=N.average(iyield1ynew,weights=mmarea,axis=(1,2))
allyinew=N.average(iyield2ynew,weights=mmarea,axis=(1,2))
allynnew=N.average(iyield3ynew,weights=mmarea,axis=(1,2))
allycnew=N.average(iyield4ynew,weights=mmarea,axis=(1,2))
allyclinew=N.average(iyield5ynew,weights=mmarea,axis=(1,2))
...
eallynew=N.average(eiyield1ynew,weights=mmarea,axis=(1,2))
eallyinew=N.average(eiyield2ynew,weights=mmarea,axis=(1,2))
eallynnew=N.average(eiyield3ynew,weights=mmarea,axis=(1,2))
eallycnew=N.average(eiyield4ynew,weights=mmarea,axis=(1,2))
eallyclinew=N.average(eiyield5ynew,weights=mmarea,axis=(1,2))
...
plt.savefig('mai_region_all_m3.png')
plt.show()
