...
#plt.contour(x, y, ipa,colors='none', linestyles='-')
...
cs1=plt.contourf(x,y,ipd,colors='none',edgecolor='green',hatches=[".."])
...
plt.savefig('soyisamfixedirr_1996_2005_paperp.jpg',dpi=300,bbox_inches='tight')
plt.show()
