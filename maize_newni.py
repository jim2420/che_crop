...
for i, year1 in enumerate(years2):
    ...
    yieldf2i[i, :, :] = yield2i
    yield2n = base2n.variables["yield"][0,:,:]
    yieldf2n[i, :, :] = yield2n
    ...
    yield2ai = base2ai.variables["yield"][0,:,:]
    yieldf2ai[i, :, :] = yield2ai

    yield2an = base2an.variables["yield"][0,:,:]
...
plt.savefig('maize2000_irrnir.jpg',dpi=300,bbox_inches='tight')
plt.show()
