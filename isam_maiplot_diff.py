...
dat=NetCDFFile('finalyield/isam/heat/fertfao/isamhis_maiscaleiyield_heat_fertfao.nc','r')
iyield1 = dat.variables['yield'][99,:,:]
dat2=NetCDFFile('finalyield/isam/heat/isamhis_maiscaleiyield_heat.nc','r')
iyield2 = dat2.variables['yield'][99,:,:]
dat3=NetCDFFile('finalyield/isam/heat/isamhis_maiscaleifyield_heat.nc','r')
iyield3 = dat3.variables['yield'][99,:,:]
dat4=NetCDFFile('finalyield/isam/heat/fertall/isamhis_maiscaleiyield_heat_fertall.nc','r')
iyield4 = dat4.variables['yield'][99,:,:]
dat5=NetCDFFile('finalyield/isam/noheat_notrop/isamhiscru_maiscaleiyield.nc','r')
iyield5 = dat5.variables['yield'][99,:,:]
dat6=NetCDFFile('finalyield/isam/heat/isamhiscru_maiscaleiyield_heat.nc','r')
iyield6 = dat6.variables['yield'][99,:,:]
dat7=NetCDFFile('finalyield/isam/noheat_notrop/isamhiscru_maiscaleifyield.nc','r')
iyield7 = dat7.variables['yield'][99,:,:]
dat8=NetCDFFile('finalyield/isam/heat/isamhiscru_maiscaleifyield_heat.nc','r')
...
ax2.set_title("CESM-ISAM Maize Yield FAON(t/ha)",fontsize=20)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,iyield1,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield2,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield3,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield4,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
ax2.set_title("Nscale-NoNscale Maize Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield3-iyield2,cmap=plt.cm.bwr,vmin=-2,vmax=2)
...
ax2.set_title("Nfertall-Nscale Maize Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield4-iyield3,cmap=plt.cm.bwr,vmin=-2,vmax=2)
...
ax2.set_title("NFAO-Nscale Maize Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield1-iyield3,cmap=plt.cm.bwr,vmin=-2,vmax=2)
...
ax2.set_title("Fertall-Fertfao Maize Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield4-iyield1,cmap=plt.cm.bwr,vmin=-2,vmax=2)
...
plt.savefig('maizeisam_2000d.jpg',dpi=300,bbox_inches='tight')
