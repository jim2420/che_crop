...
clm3n2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/soytemp_historical_constco2_irrig_fert_0.5x0.5.nc','r')
isamcrumai2 = clm3n2.variables['totalyield'][:,:,:]
...
plt.ylabel("Soybean yields (t/ha)",fontsize=18)
plt.tick_params(axis='both',labelsize=18)


plt.savefig('soynoco2_1961_2016_lat.png',dpi=600,bbox_inches='tight')
plt.show()
