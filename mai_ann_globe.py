...
def annualyield(year,couna,counb):
    ...
    clm3n2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/plot/finalyield/isam/heat/fertfao/isamhiscru_maiscaleiyield_heat_fertfao.nc','r')
    isamcrumai2 = clm3n2.variables['yield'][bb,:,:]
...
#plt.xticks(xdates, xdates)
	...
	ax.plot_date(xdates,isamy,"go-",label="NFix")
	ax.plot_date(xdates,isamy1,"yo-",label="NScale")
        ax.plot_date(xdates,isamy2,"ko-",label="NFao")
        ax.plot_date(xdates,isamy3,"co-",label="NAll")
	ax.plot_date(xdates,clmy,"bo-",label="CLM-NScale")
        ax.plot_date(xdates,clmy1,"bo--",label="CLM-NFix")
	...
	ccp2=scipy.stats.pearsonr(clmy,faoy)
        ...
        leg=plt.legend(['FAO', 'Nfix {:04.3f}'.format(ccp[0]),'NScale {:04.2f}'.format(ccp1[0]),'NFao {:04.2f}'.format(ccp3[0]),'NAll {:04.2f}'.format(ccp4[0]),'CLM-NScale {:04.2f}'.format(ccp2[0]),'CLM-NFix {:04.2f}'.format(ccp5[0])],fontsize=18)
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	ax = fig.add_subplot(323)
        ...
        ax.plot_date(xdates,aisamy,"go-",label="NFix")
        ax.plot_date(xdates,aisamy1,"yo-",label="NScale")
        ax.plot_date(xdates,aisamy2,"ko-",label="NFao")
        ax.plot_date(xdates,aisamy3,"co-",label="NAll")
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	ax = fig.add_subplot(325)
        ...
        ax.plot_date(xdates,mean_isamy,"go-",label="NFix")
        ax.plot_date(xdates,mean_isamy1,"yo-",label="NScale")
        ax.plot_date(xdates,mean_isamy2,"ko-",label="NFao")
        ax.plot_date(xdates,mean_isamy3,"co-",label="NAll")
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	plt.savefig('maize_faoclm_{0}.png'.format(name1),dpi=600,bbox_inches='tight')
plt.show()
