...
def annualyield(year,couna,counb):
    ...
    clm3n2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/plot/finalyield/isam/heat/fertfao/new1/isamhiscru_soyscaleiyield_fertfao_new1.nc','r')
...
#plt.xticks(xdates, xdates)
	...
	ax.plot_date(xdates,faoy,"ro-",label="FAO",linewidth=2)
        ax.plot_date(xdates,isamy2,"ko-",label="MOD")
	...
	ccp2=scipy.stats.pearsonr(clmy,faoy)
        ...
        leg=plt.legend(['FAO', 'MOD {:04.2f}'.format(ccp3[0])],fontsize=18)
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	ax = fig.add_subplot(323)
        ...
        ax.plot_date(xdates,aisamy2,"ko-",label="MOD")
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	ax = fig.add_subplot(325)
        ...
        ax.plot_date(xdates,mean_isamy2,"ko-",label="MOD")
        ax.xaxis.set_major_formatter(DateFormatter('%Y'))
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	plt.savefig('soy_faonclm_{0}_paper.png'.format(name1),dpi=600,bbox_inches='tight')
plt.show()
