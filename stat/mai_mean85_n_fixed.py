...
def nowyield(year,couna,counb):	
    ...
    clm=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/plot/finalyield/clm/clm45his_maiscaleifyield_luc2000.nc','r')
...
#	leg.get_frame().set_alpha(0.5)
	...
	plt.savefig('maize2050_his_85_luc2000.png')
	plt.show()
