...
# this create the kernel, given an array it will estimate the probability over that values
	kde_a = gaussian_kde( isaa )
	kde_b = gaussian_kde( isab )
        kde_c = gaussian_kde( isac )
        kde_d = gaussian_kde( isad )
        kde_a1 = gaussian_kde( clma )
        kde_b1 = gaussian_kde( clmb )
        kde_c1 = gaussian_kde( clmc )
        kde_d1 = gaussian_kde( clmd )
...
# plot the results
	...
	plt.plot( dist_space, kde_a(dist_space),linewidth=2.5,color='black',label='CO2')
        plt.plot( dist_space, kde_b(dist_space),linewidth=2.5,color='blue',label='CO2+CLIMATE')
        plt.plot( dist_space, kde_c(dist_space),linewidth=2.5,color='red',label='CO2+CLIMATE+N')
        plt.plot( dist_space, kde_d(dist_space),linewidth=2.5,color='green',label='CO2+CLIMATE+N+I')

#        plt.plot( dist_space, kde_a1(dist_space),linewidth=2.5,color='black',linestyle=':')
#        plt.plot( dist_space, kde_b1(dist_space),linewidth=2.5,color='blue',linestyle=':')
#        plt.plot( dist_space, kde_c1(dist_space),linewidth=2.5,color='red',linestyle=':')
#        plt.plot( dist_space, kde_d1(dist_space),linewidth=2.5,color='green',linestyle=':')
...
#        plt.savefig('maize2050_45box.png')
	plt.show()
