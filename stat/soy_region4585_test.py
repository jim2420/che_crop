...
for i in range(1,9):
	...
	fisama[i,0]=(isama50-isamhisy)/isamhisy*100.
        ...
        isama508=N.average(N.average(yieldagfa8,weights=maizetofu8*gridarea2,axis=(1,2)))
        clma508=N.average(N.average(yieldagfa18,weights=maizetofu8*gridarea2,axis=(1,2)))
        isamb508=N.average(N.average(yieldagfb8,weights=maizetofu8*gridarea2,axis=(1,2)))
        clmb508=N.average(N.average(yieldagfb18,weights=maizetofu8*gridarea2,axis=(1,2)))
        isamc508=N.average(N.average(yieldagfc8,weights=maizetofu8*gridarea2,axis=(1,2)))
        clmc508=N.average(N.average(yieldagfc18,weights=maizetofu8*gridarea2,axis=(1,2)))
        isamd508=N.average(N.average(yieldagfd8,weights=maizetofu8*gridarea2,axis=(1,2)))
        clmd508=N.average(N.average(yieldagfd18,weights=maizetofu8*gridarea2,axis=(1,2)))
        #print isama50,isamhisy,clma50,clmhisy
...
isama508=N.average(yieldagfa8,weights=maizetof8*gridarea2)
clma508=N.average(yieldagfa18,weights=maizetof8*gridarea2)
isamb508=N.average(yieldagfb8,weights=maizetof8*gridarea2)
clmb508=N.average(yieldagfb18,weights=maizetof8*gridarea2)
isamc508=N.average(yieldagfc8,weights=maizetof8*gridarea2)
clmc508=N.average(yieldagfc18,weights=maizetof8*gridarea2)
isamd508=N.average(yieldagfd8,weights=maizetof8*gridarea2)
clmd508=N.average(yieldagfd18,weights=maizetof8*gridarea2)
