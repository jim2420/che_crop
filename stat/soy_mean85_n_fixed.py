...
def nowyield(year,couna,counb):	
    ...
    clm=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/plot/finalyield/clm/clm45his_soyscaleifyield_luc2000.nc','r')
    clmyield = clm.variables['yield'][bb,:,:]
    isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/plot/finalyield/isam/heat/isamhis_soyscaleifyield_heat_luc2000.nc','r')
...
#	leg.get_frame().set_alpha(0.5)
	...
	plt.savefig('soy2050_his_85_luc2000.png')
	plt.show()
