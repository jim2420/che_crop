...
#range1=[10100,11501]
#range2=[50700,11550]
name=["globe","italy","france","us","canada","paraguay","brazil","argentina","zimbabwe","bolivia","japan","china","southafrica","iran","thailand",'southkorea',"uganda","vietnam","russia","nigeria","india","uruguay"]
range1=[10100,43400,42200,11501,10201,20900,20301,20101,34900,20200,43500,41501,33900,43000,47500,46700,34500,48200,46100,33400,42901,21300]
range2=[50700,43400,42200,11550,10212,20900,20327,20124,34900,20200,43500,41529,33900,43000,47500,46700,34500,48200,46100,33400,42929,21300]
...
plt.xticks(index + bar_width+0.2, ("Global","Italy","France","USA","Canada","Paraguay","Brazil","Argentina","Zimbabwe","Bolivia","Japan","China","South Africa","Iran","Thailand",'South Korea',"Uganda","Vietnam","Russia","Nigeria","India","Uruguay"),rotation='vertical')
...
plt.savefig('soy2050_85_cou.png')
#plt.show()
...
plt.savefig('soy2050_85_cou1.png')
...
plt.savefig('scatter_soy85_cou1.png',bbox_inches='tight')
