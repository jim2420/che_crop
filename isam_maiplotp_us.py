...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,iyield1*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=27)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield2*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=27)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield3*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=27)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield4*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=27)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield5*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=27)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield6*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=27)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield7*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=27)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield8*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=27)
...
plt.savefig('maizepisam_2000us.jpg',dpi=300,bbox_inches='tight')
