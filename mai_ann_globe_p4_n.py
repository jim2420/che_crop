...
clm3n2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1_n/maizetemp_historical_constco2_irrig_fert_0.5x0.5.nc','r')
...
plt.ylabel("Maize N limitation",fontsize=18)
plt.tick_params(axis='both',labelsize=18)


plt.savefig('mainoco2_1961_2016_latn.png',dpi=600,bbox_inches='tight')
plt.show()
