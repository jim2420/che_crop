...
#	clmtempf = clm1.variables['yield'][bb,:,:]
        ...
        isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetrop_historical_co2_rf_fert_0.5x0.5.nc','r')
        clmtropf = isam.variables['totalyield'][bb-1,:,:]

        isam1=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_rf_fert_0.5x0.5.nc','r')
        clmtempf = isam1.variables['totalyield'][bb-1,:,:]




	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetrop_historical_co2_irrig_fert_0.5x0.5.nc','r')
	clmtropfi = clm2.variables['totalyield'][bb-1,:,:]

	clm3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_irrig_fert_0.5x0.5.nc','r')
...
ncfile=NetCDFFile('isamhiscru_maiscaleiyield_fertfao_new1_long.nc','w',format='NETCDF3_64BIT_OFFSET')
