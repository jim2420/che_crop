...
def yieldout(year):
	...
	fert_maitrop = ff.variables['soy_trop_fert'][bb,:,:]
	fert_maitemp = ff.variables['soy_temp_fert'][bb,:,:]
...
#	clmtempf = clm1.variables['yield'][bb,:,:]
	clmtempfer=clm1.variables['fertilizer'][bb,:,:]
        ...
        isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/soytrop_historical_co2_rf_fert_0.5x0.5.nc','r')
        clmtropf = isam.variables['totalyield'][bb,:,:]

        isam1=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/soytemp_historical_co2_rf_fert_0.5x0.5.nc','r')
        clmtempf = isam1.variables['totalyield'][bb,:,:]




	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/soytrop_historical_co2_irrig_fert_0.5x0.5.nc','r')
	clmtropfi = clm2.variables['totalyield'][bb,:,:]

	clm3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/soytemp_historical_co2_irrig_fert_0.5x0.5.nc','r')
	clmtempfi = clm3.variables['totalyield'][bb,:,:]



	clma=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/soytrop_historical_co2_rf_nofert_0.5x0.5.nc','r')
	clmtropfno = clma.variables['totalyield'][bb,:,:]

	clm1a=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/soytemp_historical_co2_rf_nofert_0.5x0.5.nc','r')
	clmtempfno = clm1a.variables['totalyield'][bb,:,:]

	clm2a=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/soytrop_historical_co2_irrig_nofert_0.5x0.5.nc','r')
	clmtropfnoi = clm2a.variables['totalyield'][bb,:,:]

	clm3a=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/soytemp_historical_co2_irrig_nofert_0.5x0.5.nc','r')
...
ncfile=NetCDFFile('isamhiscru_soyscaleifyield_heat.nc','w',format='NETCDF3_64BIT_OFFSET')
