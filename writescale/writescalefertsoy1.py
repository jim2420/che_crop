...
def yieldout(year):
	...
	clm2a=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/soytrop_historical_co2_irrig_nofert_0.5x0.5.nc','r')
	clmtropfnoi = clm2a.variables['yield'][bb,:,:]

	clm3a=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/soytemp_historical_co2_irrig_nofert_0.5x0.5.nc','r')
...
ncfile=NetCDFFile('clm45his_soyscaleifyield_luc2000.nc','w',format='NETCDF3_64BIT_OFFSET')
