...
def yieldout(year):
	...
	if bb <=105: 
		...
		maitrop = region1.variables['maize_trop'][104,:,:]
		maitemp = region1.variables['maize_temp'][104,:,:]
		maitropi=region1.variables['maize_trop_irrig'][104,:,:]
		maitempi=region1.variables['maize_temp_irrig'][104,:,:]
	...
	if bb <=105:
		...
		fert_maitrop = ff.variables['maize_trop_fert'][104,:,:]
		fert_maitemp = ff.variables['maize_temp_fert'][104,:,:]
...
#	clmtropf = clm.variables['yield'][bb,:,:]
		...
		clmtropfer=clm.variables['fertilizer'][104,:,:]
...
#	clmtempf = clm1.variables['yield'][bb,:,:]
		...
		clmtempfer=clm1.variables['fertilizer'][104,:,:]

        isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetrop_historical_co2_rf_fert_notill_0.5x0.5.nc','r')
        clmtropf = isam.variables['totalyield'][bb-1,:,:]

        isam1=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_rf_fert_notill_0.5x0.5.nc','r')
        clmtempf = isam1.variables['totalyield'][bb-1,:,:]




	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetrop_historical_co2_irrig_fert_notill_0.5x0.5.nc','r')
	clmtropfi = clm2.variables['totalyield'][bb-1,:,:]

	clm3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_irrig_fert_notill_0.5x0.5.nc','r')
	clmtempfi = clm3.variables['totalyield'][bb-1,:,:]



	clma=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetrop_historical_co2_rf_nofert_0.5x0.5.nc','r')
	clmtropfno = clma.variables['totalyield'][bb-1,:,:]

	clm1a=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_rf_nofert_0.5x0.5.nc','r')
	clmtempfno = clm1a.variables['totalyield'][bb-1,:,:]

	clm2a=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetrop_historical_co2_irrig_nofert_0.5x0.5.nc','r')
	clmtropfnoi = clm2a.variables['totalyield'][bb-1,:,:]

	clm3a=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_irrig_nofert_0.5x0.5.nc','r')
...
ncfile=NetCDFFile('isamhiscru_maiscaleiyield_fertfao_new1_long_notill.nc','w',format='NETCDF3_64BIT_OFFSET')
ncfile.createDimension('lat', 360)
ncfile.createDimension('lon', 720)
ncfile.createDimension('time', 116)
