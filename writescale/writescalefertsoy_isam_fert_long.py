...
def yieldout(year):
	...
	if bb <=105: 
		...
		maitrop = region1.variables['soy_trop'][104,:,:]
		maitemp = region1.variables['soy_temp'][104,:,:]
		maitropi=region1.variables['soy_trop_irrig'][104,:,:]
		maitempi=region1.variables['soy_temp_irrig'][104,:,:]
	...
	if bb <=105:
		...
		fert_maitrop = ff.variables['soy_trop_fert'][104,:,:]
		fert_maitemp = ff.variables['soy_temp_fert'][104,:,:]
...
ncfile=NetCDFFile('isamhiscru_soyscaleiyield_fertfao_new1_long.nc','w',format='NETCDF3_64BIT_OFFSET')
