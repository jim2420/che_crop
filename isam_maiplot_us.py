...
ax2.set_title("CESM-ISAM HS Maize Yield (t/ha)",fontsize=20)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
ax2.set_title("CESM-ISAM Nscale HS Maize Yield (t/ha)",fontsize=20)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
plt.savefig('maizeisam_2000us.jpg',dpi=300,bbox_inches='tight')
