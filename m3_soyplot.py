...
ax.set_title("M3 Soy Yield (t/ha)",fontsize=20)
...
map.drawmapboundary()
iizumy=iyield
cs = map.pcolormesh(x,y,iizumy,cmap=plt.cm.YlGn,vmin=0,vmax=6)
...
ax.set_title("M3 Soy Production (t)",fontsize=20)
...
map.drawmapboundary()
iizumy1=iyield1
cs = map.pcolormesh(x,y,iizumy1,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=2000)
...
plt.savefig('m3soy.jpg',dpi=600,bbox_inches='tight')
