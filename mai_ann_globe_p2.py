...
#plt.xticks(xdates, xdates)
	...
	ax.plot_date(xdates,faoy,"ro-",label="FAO",linewidth=2)
        ...
        ax.plot_date(xdates,clmy1,"go-",label="CLM-Scale")
	...
	ccp2=scipy.stats.pearsonr(clmy,faoy)
        ...
        leg=plt.legend(['FAO','ISAM {:04.2f}'.format(ccp3[0]),'CLM','CLM-Scale'],fontsize=18)
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	plt.savefig('maize_faoclm_{0}_1961_2016_a.png'.format(name1),dpi=600,bbox_inches='tight')
plt.show()
