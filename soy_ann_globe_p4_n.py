...
clm3n2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1_n/soytemp_historical_constco2_irrig_fert_0.5x0.5.nc','r')
isamcrumai2 = clm3n2.variables['total_gfna'][:,:,:]
lonisam=clm3n2.variables['lon'][:]
...
#isamcrumai2= ma.masked_where(isamcrumai2<=0,isamcrumai2)
isamcrumai2=ma.filled(isamcrumai2, fill_value=0.)
isamcrumai2,lonisam1 = shiftgrid(180.5,isamcrumai2,lonisam,start=False)
print lonisam1
...
plt.ylabel("Soybean N limitation",fontsize=18)
plt.tick_params(axis='both',labelsize=18)


plt.savefig('soynoco2_1961_2016_latn.png',dpi=600,bbox_inches='tight')
plt.show()
