...
ax2.set_title("CESM-ISAM (1000 t)",fontsize=20)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,iyield1*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=7)
...
ax2.set_title("CESM-ISAM HS (1000 t)",fontsize=20)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield2*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=7)
...
ax2.set_title("CESM-ISAM Nscale (1000 t)",fontsize=20)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield3*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=7)
...
ax2.set_title("CESM-ISAM Nscale HS (1000 t)",fontsize=20)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield4*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=7)
...
ax2.set_title("NCEP-ISAM (1000 t)",fontsize=20)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield5*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=7)
...
ax2.set_title("NCEP-ISAM HS (1000 t)",fontsize=20)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield6*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=7)
...
ax2.set_title("NCEP-ISAM Nscale (1000 t)",fontsize=20)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield7*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=7)
...
ax2.set_title("NCEP-ISAM Nscale HS (1000 t)",fontsize=20)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield8*iaream/1000,cmap=plt.cm.YlGn,vmin=0,vmax=7)
...
plt.savefig('soypisam_2000us.jpg',dpi=300,bbox_inches='tight')
