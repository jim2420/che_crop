...
#    print lon1
    clm=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_rf_fert_0.5x0.5.nc','r')
    clmtropf = clm.variables['totalyield'][bb,:,:]
    clmtropf= ma.masked_where(clmtropf<=0,clmtropf)
    clmtropf=ma.filled(clmtropf, fill_value=0.)

    clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_irrig_fert_0.5x0.5.nc','r')
    ...
    clm3n=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_rf_nofert_0.5x0.5.nc','r')
    isammai = clm3n.variables['totalyield'][bb,:,:]
    isammai= ma.masked_where(isammai<=0,isammai)
    isammai=ma.filled(isammai,fill_value=0.)


    clm3n1=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_irrig_fert_var_0.5x0.5.nc','r')
    ...
    clm3n2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_irrig_nofert_0.5x0.5.nc','r')
    ...
    clm3n3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamhistorical_cru/heat/fertfao/fixedirr_new1/maizetemp_historical_co2_irrig_nofert_var_0.5x0.5.nc','r')
...
#plt.xticks(xdates, xdates)
	...
	ax.plot_date(xdates1,faoy,"ro-",label="FAO",linewidth=2)
        ...
        ax.plot_date(xdates,clmy1,"bo-",label="Base")
        ax.plot_date(xdates,clmy,"go-",label="NO-I")
        ax.plot_date(xdates,isamy,"yo-",label="NO-I & NF")
        ax.plot_date(xdates,isamy1,"mo-",label="Base_var")
#        ax.plot_date(xdates,isamy3,"co-",label="No-NF_var")
	...
	plt.savefig('maize_faoclm_{0}_1961_2016_a5.png'.format(name1),dpi=600,bbox_inches='tight')
plt.show()
