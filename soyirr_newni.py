...
clma=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/soytrop_historical_co2_rf_nofert_0.5x0.5.nc','r')
clman=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/soytrop_historical_co2_rf_fert_0.5x0.5.nc','r')
clmai=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/soytrop_historical_co2_irrig_nofert_0.5x0.5.nc','r')
clm=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/soytrop_historical_co2_irrig_fert_0.5x0.5.nc','r')
...
clm1a=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/soytemp_historical_co2_rf_nofert_0.5x0.5.nc','r')
clm1an=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/soytemp_historical_co2_rf_fert_0.5x0.5.nc','r')
clm1ai=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/soytemp_historical_co2_irrig_nofert_0.5x0.5.nc','r')
clm1=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/soytemp_historical_co2_irrig_fert_0.5x0.5.nc','r')
...
for i, year in enumerate(years):
    ...
    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year), mode='r')
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_fert/output/hsoyhis_fert.bgp-yearly_crop_{0}.nc".format(year), mode='r')
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_irr/output/hsoyhis_irr.bgp-yearly_crop_{0}.nc".format(year), mode='r')
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_irr_fert/output/hsoyhis_irr_fert.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    lona1 = base.variables["lon"][:]
    lata1 = base.variables["lat"][:]


    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year), mode='r')
#    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_fertrop/output/hsoyhis_fertrop.bgp-yearly_crop_{0}.nc".format(year), mode='r')
#    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_irr/output/hsoyhis_irr.bgp-yearly_crop_{0}.nc".format(year), mode='r')
#    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_irr_fertrop/output/hsoyhis_irr_fertrop.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
for i, year1 in enumerate(years2):
    #    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2n = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_fert/output/hsoyhis_fert.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2i = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_irr/output/hsoyhis_irr.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_irr_fert/output/hsoyhis_irr_fert.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    yield2 = base2.variables["irrigation"][1,:,:]
    yieldf2[i, :, :] = yield2
    yield2i = base2i.variables["irrigation"][1,:,:]
    yieldf2i[i, :, :] = yield2i
    yield2n = base2n.variables["irrigation"][1,:,:]
    yieldf2n[i, :, :] = yield2n


    #base2a = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2an = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_fertrop/output/hsoyhis_fertrop.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2ai = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_irr/output/hsoyhis_irr.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2a = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/his/heat/soyhis_irr_fertrop/output/hsoyhis_irr_fertrop.bgp-yearly_crop_{0}.nc".format(year1), mode='r')

    yield2a = base2a.variables["irrigation"][1,:,:]
    yieldf2a[i, :, :] = yield2a

    yield2ai = base2ai.variables["irrigation"][1,:,:]
    yieldf2ai[i, :, :] = yield2ai

    yield2an = base2an.variables["irrigation"][1,:,:]
...
plt.savefig('soy2000irr_irrnir.jpg',dpi=300,bbox_inches='tight')
plt.show()
