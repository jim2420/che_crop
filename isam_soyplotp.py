...
dat=NetCDFFile('finalyield/isam/isamhis_soyscaleiyield.nc','r')
iyield1 = dat.variables['yield'][99,:,:]
dat2=NetCDFFile('finalyield/isam/isamhis_soyscaleiyield_heat.nc','r')
iyield2 = dat2.variables['yield'][99,:,:]
dat3=NetCDFFile('finalyield/isam/isamhis_soyscaleifyield.nc','r')
iyield3 = dat3.variables['yield'][99,:,:]
dat4=NetCDFFile('finalyield/isam/isamhis_soyscaleifyield_heat.nc','r')
iyield4 = dat4.variables['yield'][99,:,:]
dat5=NetCDFFile('finalyield/isam/isamhiscru_soyscaleiyield.nc','r')
iyield5 = dat5.variables['yield'][99,:,:]
dat6=NetCDFFile('finalyield/isam/isamhiscru_soyscaleiyield_heat.nc','r')
iyield6 = dat6.variables['yield'][99,:,:]
dat7=NetCDFFile('finalyield/isam/isamhiscru_soyscaleifyield.nc','r')
iyield7 = dat7.variables['yield'][99,:,:]
dat8=NetCDFFile('finalyield/isam/isamhiscru_soyscaleifyield_heat.nc','r')
...
ax2.set_title("CESM-ISAM Soy",fontsize=20)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,iyield1*iaream/1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=2)
...
ax2.set_title("CESM-ISAM HS Soy",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield2*iaream/1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=2)
...
ax2.set_title("CESM-ISAM Nscale Soy",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield3*iaream/1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=2)
...
ax2.set_title("CESM-ISAM Nscale HS Soy",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield4*iaream/1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=2)
...
ax2.set_title("NCEP-ISAM Soy",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield5*iaream/1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=2)
...
ax2.set_title("NCEP-ISAM HS Soy",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield6*iaream/1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=2)
...
ax2.set_title("NCEP-ISAM Nscale Soy",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield7*iaream/1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=2)
...
ax2.set_title("NCEP-ISAM Nscale HS Soy",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield8*iaream/1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=2)
...
plt.savefig('soyisamp_2000.jpg',dpi=600,bbox_inches='tight')
