...
def annualyield(year,couna,counb):
    ...
    clm3n2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/plot/finalyield/isam/heat/fertfao/isamhiscru_soyscaleiyield_heat_fertfao.nc','r')
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	plt.savefig('soy_faonclm_{0}.png'.format(name1),dpi=600,bbox_inches='tight')
plt.show()
