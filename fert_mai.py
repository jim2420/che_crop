...
datc=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/maizetemp_historical_co2_rf_nofert_0.5x0.5.nc','r')
iyield1c = datc.variables['yield'][99,:,:]
dat2c=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45historical/maizetemp_historical_co2_rf_fert_0.5x0.5.nc','r')
...
dat=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/noheat/maihis/output/maihis.nc','r')
iyield1 = dat.variables['totalyield'][99,:,:]
dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/noheat/maihis_fert/output/maihis_fert.nc','r')
iyield2 = dat2.variables['totalyield'][99,:,:]
dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/his_cru/noheat/maihis_fertall/output/maihis_fertall.nc','r')
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,iyield1c,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
ax2.set_title("CLM Maize Yield Fert (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
x,y = map(gridlon1,gridlat1)
map.drawcoastlines()
map.drawcountries()
...
cs = map.pcolormesh(x,y,iyield2c,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
ax2.set_title("ISAM Maize Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
x,y = map(gridlon1,gridlat1)
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,iyield1f,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
ax2.set_title("ISAM Maize Yield Fert (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
x,y = map(gridlon1,gridlat1)
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,iyield2f,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
ax2.set_title("ISAM Maize Yield No N limit (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
x,y = map(gridlon1,gridlat1)
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,iyield3f,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
plt.savefig('maifert_2000.jpg',dpi=300,bbox_inches='tight')
