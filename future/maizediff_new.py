...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yieldclm,cmap=plt.cm.bwr,vmin=-6,vmax=6)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yieldisam,cmap=plt.cm.bwr,vmin=-6,vmax=6)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
plt.savefig('scp45maizeag_2090.jpg',dpi=300,bbox_inches='tight')
plt.show()
