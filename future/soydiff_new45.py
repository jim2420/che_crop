...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yieldclm,cmap=plt.cm.bwr,vmin=-2,vmax=2)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yieldisam,cmap=plt.cm.bwr,vmin=-2,vmax=2)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
plt.savefig('scp45soyd_2090.jpg',dpi=300,bbox_inches='tight')
plt.show()
