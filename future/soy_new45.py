...
clmtropa = clm.variables['yield'][84:93,:,:]#2090-2099
...
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis_fert/output/hsoyhis_fert.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/new/soyhis_irr_fert/output/hsoyhis_irr_fert.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
#    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis_fertrop/output/hsoyhis_fertrop.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/new/soyhis_irr_fertrop/output/hsoyhis_irr_fertrop.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
#    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis_fert/output/hsoyhis_fert.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/new/soyhis_irr_fert/output/hsoyhis_irr_fert.bgp-yearly_crop_{0}.nc".format(year1), mode='r')  
...
#    base2a = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis_fertrop/output/hsoyhis_fertrop.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2a = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/new/soyhis_irr_fertrop/output/hsoyhis_irr_fertrop.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2,cmap=plt.cm.jet,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=5)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('scp45soyyd_2090_vm.jpg',dpi=300,bbox_inches='tight')
plt.show()
