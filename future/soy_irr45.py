...
clm1y=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45rcp45/soytemp_rcp45_co2_rf_fert_0.5x0.5.nc','r')
...
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    basey = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis_fert/output/hsoyhis_fert.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
#    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    baseay = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis_fertrop/output/hsoyhis_fertrop.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    ...
    yield1 = base.variables["irrigation"][1,:,:]
    yieldf[i, :, :] = yield1
    yield1a = basea.variables["irrigation"][1,:,:]
    yieldfa[i, :, :] = yield1a


    yield1y = base.variables["yield"][1,:,:]
    yieldfy[i, :, :] = yield1y
    yield1ay = basea.variables["yield"][1,:,:]
    yieldfay[i, :, :] = yield1ay

    yield1y1 = basey.variables["yield"][1,:,:]
    yieldfy1[i, :, :] = yield1y1
    yield1ay1 = baseay.variables["yield"][1,:,:]
...
#    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2y = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis_fert/output/hsoyhis_fert.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    ...
    yield2 = base2.variables["irrigation"][1,:,:]
    yieldf2[i, :, :] = yield2

    yield2y = base2.variables["yield"][1,:,:]
    yieldf2y[i, :, :] = yield2y
    yield2y1 = base2y.variables["yield"][1,:,:]
...
#    base2a = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2ay = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/soyhis_fertrop/output/hsoyhis_fertrop.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    ...
    yield2a = base2a.variables["irrigation"][1,:,:]
    yieldf2a[i, :, :] = yield2a
    yield2ay = base2a.variables["yield"][1,:,:]
    yieldf2ay[i, :, :] = yield2ay
    yield2ay1 = base2ay.variables["yield"][1,:,:]
...
ax1.set_title("CLM yield/irrigation 2010s (t/ha/mm/yr)",fontsize=18)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(clmhisy-clmhisy1)/clmhis*100,cmap=plt.cm.bwr,vmin=-1,vmax=1)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12) 
plt.axis('off')

ax2 = fig.add_subplot(322)
ax2.set_title("ISAM yield/irrigation 2010s (t/ha/mm/yr)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(llcrnrlon=-119,llcrnrlat=23,urcrnrlon=-63,urcrnrlat=51,projection='lcc',lat_1=33,lat_2=45,lon_0=-95)
map.drawcoastlines()
#map.drawstates()
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(yield_newy-yield_newy1)/yield_new*100,cmap=plt.cm.bwr,vmin=-1,vmax=1)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

ax5 = fig.add_subplot(323)
ax5.set_title("CLM yield/irrigation 2050s (t/ha/mm/yr)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(llcrnrlon=-119,llcrnrlat=23,urcrnrlon=-63,urcrnrlat=51,projection='lcc',lat_1=33,lat_2=45,lon_0=-95)
map.drawcoastlines()
#map.drawstates()
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(clmfuturey-clmfuturey1)/clmfuture*100,cmap=plt.cm.bwr,vmin=-1,vmax=1)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
ax5.set_title("ISAM yield/irrigation 2050s (t/ha/mm/yr)",fontsize=18)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(llcrnrlon=-119,llcrnrlat=23,urcrnrlon=-63,urcrnrlat=51,projection='lcc',lat_1=33,lat_2=45,lon_0=-95)
map.drawcoastlines()
#map.drawstates()
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(yield_new2y-yield_new2y1)/yield_new2*100,cmap=plt.cm.bwr,vmin=-1,vmax=1)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
ax5.set_title("CLM yield/irrigation 2050s-2010s (%)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(llcrnrlon=-119,llcrnrlat=23,urcrnrlon=-63,urcrnrlat=51,projection='lcc',lat_1=33,lat_2=45,lon_0=-95)
map.drawcoastlines()
#map.drawstates()
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(((clmfuturey-clmfuturey1)/clmfuture*100)-((clmhisy-clmhisy1)/clmhis*100))/((clmhisy-clmhisy1)/clmhis*100)*100,cmap=plt.cm.bwr,vmin=-80,vmax=80)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
ax5.set_title("ISAM yield/irrigation 2050s-2010s (%)",fontsize=18)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(llcrnrlon=-119,llcrnrlat=23,urcrnrlon=-63,urcrnrlat=51,projection='lcc',lat_1=33,lat_2=45,lon_0=-95)
map.drawcoastlines()
#map.drawstates()
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(((yield_new2y-yield_new2y1)/yield_new2*100)-((yield_newy-yield_newy1)/yield_new*100))/((yield_newy-yield_newy1)/yield_new*100)*100,cmap=plt.cm.bwr,vmin=-80,vmax=80)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('scp45soyyd_irry.jpg',dpi=300,bbox_inches='tight')
plt.show()
