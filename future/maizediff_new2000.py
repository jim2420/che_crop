...
clma=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/plot/finalyield/clm/clm45his_maiscaleifyield_luc2000.nc','r')


clmtrop = clma.variables['yield'][95:104,:,:]#1996-2005
...
clm1a=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/plot/finalyield/clm/clm45his_maiscaleifyield_luc2000.nc','r')


clmtemp = clm1a.variables['yield'][95:104,:,:]
...
#    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp45/heat/maihis_irr_fertrop/output/hmaizehis_irr_fertrop.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/cheyenne/plot/finalyield/isam/heat/isamhis_maiscaleifyield_heat_luc2000.nc','r')

    yield1 = isam.variables["yield"][year,:,:]
    yieldf[i, :, :] = yield1
    yield1a = isam.variables["yield"][year,:,:]
    yieldfa[i, :, :] = yield1a
...
plt.savefig('rcp45maize_2000d.jpg',dpi=300,bbox_inches='tight')
plt.show()
