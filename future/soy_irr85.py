...
clmy=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45rcp85/soytrop_rcp85_co2_rf_fert_0.5x0.5.nc','r')
...
clm1y=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45rcp85/soytemp_rcp85_co2_rf_fert_0.5x0.5.nc','r')
...
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp85/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    basey = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp85/heat/soyhis_fert/output/hsoyhis_fert.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
#    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp85/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    baseay = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp85/heat/soyhis_fertrop/output/hsoyhis_fertrop.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
#    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp85/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2y = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp85/heat/soyhis_fert/output/hsoyhis_fert.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
...
#    base2a = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp85/heat/soyhis/output/hsoyhis.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2ay = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/rcp85/heat/soyhis_fertrop/output/hsoyhis_fertrop.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
...
plt.savefig('scp85soyyd_irry.jpg',dpi=300,bbox_inches='tight')
plt.show()
