...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,clmhis,cmap=plt.cm.jet,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=16)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new,cmap=plt.cm.jet,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=16)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,clmfuture,cmap=plt.cm.jet,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=16)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2,cmap=plt.cm.jet,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=16)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('scp45maiyd_2090.jpg',dpi=300,bbox_inches='tight')
plt.show()
