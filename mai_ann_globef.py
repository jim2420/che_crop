...
def annualyield(year,couna,counb):
    ...
    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp85/noheat/maizetemp_rcp85_constco2_rf_nofert_0.5x0.5.nc", mode='r')
    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp85/noheat/maizetemp_rcp85_co2_rf_nofert_0.5x0.5.nc", mode='r')
    ...
    basei = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp85/noheat/maizetemp_rcp85_co2_rf_fert_0.5x0.5.nc", mode='r')
    base2i = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/cheyenne/yieldout/isamrcp85/noheat/maizetemp_rcp85_co2_irrig_fert_0.5x0.5.nc", mode='r')
