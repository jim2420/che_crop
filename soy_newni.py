...
clmtropn = clman.variables['yield'][99,:,:]#2010-2019
clmtropfn=clmtropn
clmtropi = clmai.variables['yield'][99,:,:]#2010-2019
clmtropfi=clmtropi
...
clmtempn = clm1an.variables['yield'][99,:,:]
clmtempfn=clmtempn
clmtempi = clm1ai.variables['yield'][99,:,:]
clmtempfi=clmtempi
...
for i, year1 in enumerate(years2):
    ...
    yieldf2i[i, :, :] = yield2i
    yield2n = base2n.variables["yield"][1,:,:]
    yieldf2n[i, :, :] = yield2n
    ...
    yield2ai = base2ai.variables["yield"][1,:,:]
    yieldf2ai[i, :, :] = yield2ai

    yield2an = base2an.variables["yield"][1,:,:]
...
ax1.set_title("CLM yield 2000 I+R - I - N compare base (%)",fontsize=18)
...
cs = map.pcolormesh(x,y,(clmfuture-clmhisn-clmhisi+clmhis)/clmhis*100,cmap=plt.cm.bwr,vmin=-50,vmax=50)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12) 
plt.axis('off')

ax2 = fig.add_subplot(222)
ax2.set_title("ISAM yield 2000 I+R - I - N compare base (%)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(llcrnrlon=-119,llcrnrlat=23,urcrnrlon=-63,urcrnrlat=51,projection='lcc',lat_1=33,lat_2=45,lon_0=-95)
map.drawcoastlines()
#map.drawstates()
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(yield_new2-yield_new2n-yield_new2i+yield_new)/yield_new*100,cmap=plt.cm.bwr,vmin=-50,vmax=50)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

ax5 = fig.add_subplot(223)
ax5.set_title("CLM yield 2000 I+R - I - N compare base (%)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(llcrnrlon=-119,llcrnrlat=23,urcrnrlon=-63,urcrnrlat=51,projection='lcc',lat_1=33,lat_2=45,lon_0=-95)
map.drawcoastlines()
#map.drawstates()
...
cs = map.pcolormesh(x,y,cni-(cn+ci),cmap=plt.cm.bwr,vmin=-10,vmax=10)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
ax5.set_title("ISAM yield 2000 I+R - I - N compare base (%)",fontsize=18)
#map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(llcrnrlon=-119,llcrnrlat=23,urcrnrlon=-63,urcrnrlat=51,projection='lcc',lat_1=33,lat_2=45,lon_0=-95)
map.drawcoastlines()
#map.drawstates()
...
cs = map.pcolormesh(x,y,isamni-(isamn+isami),cmap=plt.cm.bwr,vmin=-10,vmax=10)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('soy2000_irrnir.jpg',dpi=300,bbox_inches='tight')
plt.show()
