...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield5,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield6,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield7,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,iyield8,cmap=plt.cm.YlGn,vmin=0,vmax=16)
...
plt.savefig('maizeisam_2000.jpg',dpi=300,bbox_inches='tight')
