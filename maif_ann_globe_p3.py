...
clm3n2=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/Hisfaofert_plot.nc','r')
isamcrumai2 = clm3n2.variables['maize_fert'][:,:,:]
...
plt.ylabel("N fertilizer (kgN/ha)",fontsize=18)
plt.tick_params(axis='both',labelsize=18)


plt.savefig('maif_1961_2016_lat.png',dpi=600,bbox_inches='tight')
plt.show()
